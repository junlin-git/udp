...
static void udp_server_msg(int fd)
{
...
static int init_server()
{
    ...
    udp_server_msg(server_fd);   //处理接收到的数据
...
static void udp_client_msg(int fd, struct sockaddr* dst)
{
...
static int init_client()
{
    ...
    udp_client_msg(client_fd, (struct sockaddr*)&ser_addr);
